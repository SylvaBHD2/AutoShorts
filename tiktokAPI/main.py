...
def tts(session_id: str, text_speaker: str = "en_us_002", req_text: str = "TikTok Text To Speech", filename: str = 'voice.mp3', play: bool = False):
    ...
    # baseURL="https://api16-normal-v6.tiktokv.com/media/api/text/speech/invoke"
    baseURL="https://api16-normal-c-useast2a.tiktokv.com/media/api/text/speech/invoke/"
    url = f"{baseURL}/?text_speaker={text_speaker}&req_text={req_text}&speaker_map_type=0&aid=1233"
